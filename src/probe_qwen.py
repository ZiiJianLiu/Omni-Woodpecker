...
from owp.evaluation.datasets import (
...
from avcd import run_avcd_dominance_reader, tokenizer_ids
from mad import (
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Qwen OWP query-conditioned typing probe. "
...
def write_oom_event(
    ...
    *,
    ...
    payload = {
        "kind": "qwen_owp_typing_oom_event",
...
def score_branch(
    ...
    *,
    ...
    try:
        with adapter.temporary_release_cuda_reserve(f"qwen_owp_branch:{branch}"):

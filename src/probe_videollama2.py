...
from probe_qwen import (  # noqa: E402
...
from videollama2_runtime import (  # noqa: E402
    normalize_yes_no,
    safe_text,
...
def build_runtime_row(row: Mapping[str, Any], manifest: Mapping[str, Any]) -> dict[str, Any]:
    return {
        "sample_id": row.get("sample_id"),
        "runtime_source": "videollama2_owp_typing",
...
def main() -> None:
    ...
    if args.selected_rows_path is not None:
        ...
        from videollama2_runtime import select_avh_unary_full_rows  # noqa: WPS433

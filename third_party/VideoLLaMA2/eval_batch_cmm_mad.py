...
def run_inference(model, processor, tokenizer, sample, modal_type, accelerator):
    ...
    try:
        ...
        tensor_va = build_cmm_full_av_tensor(processor, video_path, audio_path)
        ...
        if args.max_new_tokens is not None:
            decode_kwargs["max_new_tokens"] = args.max_new_tokens
...
if __name__ == "__main__":
    ...
    parser.add_argument('--max-new-tokens', type=int, default=None,
                       help='Optional maximum new tokens override; omit to keep the original mm_contrast_decode default')
